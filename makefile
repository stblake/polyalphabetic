...
all:
	$(CC) utils.c parse.c dict.c transpositions.c perioc.c quagmire.c vigenere.c porta.c beaufort.c autokey.c optimal_cycleword.c colossus.c -o colossus
	cp colossus ..
...
testopt:
	$(CC) -DCOLOSSUS_NO_MAIN tests/test_solver.c utils.c parse.c dict.c transpositions.c perioc.c quagmire.c vigenere.c porta.c beaufort.c autokey.c optimal_cycleword.c colossus.c -o tests/test_solver
	./tests/test_solver
